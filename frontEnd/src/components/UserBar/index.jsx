...
const IndexBar = ({ tool , setTool , color , setColor , clean ,setClean , elements , setElements , history , setHistory , roomData }) => {
    ...
    const handleCopyToClipboard = () => {
        ...
        navigator.clipboard.writeText(roomData.sessionID).then(() => {
          popUp('sessionID copied' , 3000) ;
        }).catch(err => {
